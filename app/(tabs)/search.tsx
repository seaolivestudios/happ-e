          ...
          <View>
            {sections.map((section, sIndex) => {
              if (section.type === 'grid') {
                ...
                return (
                  <TouchableOpacity key={sIndex} style={styles.widescreenCard}>
            ...
            {trendingCategories.map(cat => (
              <TouchableOpacity key={cat.id} style={styles.categoryRow}>
                ...
                <View style={styles.categoryInfo}>
                  ...
                  <Text style={styles.categoryPosts}>{cat.posts} posts</Text>
                </View>
...
const styles = StyleSheet.create({
  ...
  gridCell: { width: colWidth, height: cardHeight, borderRadius: 8, overflow: 'hidden', position: 'relative' },
  ...
  widescreenCard: { marginHorizontal: 16, marginVertical: 8, borderRadius: 12, overflow: 'hidden', height: (width - 32) * (9 / 16) },
