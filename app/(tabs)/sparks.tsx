...
const styles = StyleSheet.create({
  ...
  body: { flex: 1 },
  todayBanner: { backgroundColor: '#111111', margin: 12, borderRadius: 16, padding: 18, borderWidth: 1, borderColor: '#FFC300' },
  ...
  sectionLabel: { fontSize: 14, fontWeight: '700', color: '#FFC300', paddingHorizontal: 16, marginTop: 20, marginBottom: 4 },
  sectionSub: { fontSize: 12, color: '#888888', paddingHorizontal: 16, marginBottom: 12 },
  sparkCard: { backgroundColor: '#111111', borderRadius: 16, marginHorizontal: 12, marginBottom: 12, borderWidth: 1, borderColor: '#222222', overflow: 'hidden' },
  ...
  sparkCaption: { fontSize: 14, color: '#CCCCCC', lineHeight: 20 },
  sparkActions: { flexDirection: 'row', gap: 20, paddingHorizontal: 12, paddingVertical: 10, borderTopWidth: 0.5, borderTopColor: '#222222' },
  ...
  endText: { fontSize: 14, fontWeight: '600', color: '#888888' },
  endSub: { fontSize: 12, color: '#555555', marginTop: 4 },
});
